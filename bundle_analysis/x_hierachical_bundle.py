...
url_list=[]
pathway="xbundle_22500_sig30_50_cluster_0p4/"

try:
    os.mkdir("xbundle_22500_sig30_50_cluster_0p4_fig")
except:
    print exist
...
for cluster in cluster_list:
    ...
    # plt.show()
    plt.savefig(pathway[:-1]+"_fig/"+cluster+"_complete.png",dpi=100)
    plt.close()
    # #######Sorting###########
    Heat_new_matrix=[]
    for i in new_ids:
    ...
    # ax.set_clim([0.0,1.0])
    # plt.show()
    plt.savefig(pathway[:-1]+"_fig/"+cluster+"_heatmap_complete.png",dpi=100)
    plt.close()
