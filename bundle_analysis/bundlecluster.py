...
for j in xrange(len(count_list)):
    if count_list[j] >= 200:
        with open("bundle_cluster_0p4/static_cluster_200up.txt", "at") as fp:
            fp.writelines("cluster_" + str(j) + '\n')
    elif count_list[j] >= 100:
        with open("bundle_cluster_0p4/static_cluster_100up.txt", "at") as fp:
            fp.writelines("cluster_" + str(j) + '\n')
    elif count_list[j] >= 50:
        with open("bundle_cluster_0p4/static_cluster_50up.txt", "at") as fp:
            fp.writelines("cluster_" + str(j) + '\n')
    elif count_list[j] >= 10:
        with open("bundle_cluster_0p4/static_cluster_10up.txt", "at") as fp:
            fp.writelines("cluster_" + str(j) + '\n')
    elif count_list[j] >= 3:
        with open("bundle_cluster_0p4/static_cluster_3up.txt", "at") as fp:
            fp.writelines("cluster_" + str(j) + '\n')
    elif count_list[j] >= 1:
        with open("bundle_cluster_0p4/static_cluster_1up.txt", "at") as fp:
            fp.writelines("cluster_" + str(j) + '\n')
...
for j in xrange(len(assembly_collection)):
    with open ("bundle_cluster_0p4/cluster_"+str(assembly_index[j])+"_correlation_map.txt","wt") as fp:
