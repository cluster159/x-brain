...
url=["static_cluster_200up.txt","static_cluster_100up.txt","static_cluster_50up.txt"]
...
for kk in url:
    ...
    for i in xrange(len(X)):
        ...
        plt.plot(X[i], Y[i], Z[i], "o", markersize=2, color=(R[i], G[i], B[i], 0.1))
    QQ=QQ+1
...
for iii in xrange(10):
    for jjj in xrange(10):
        ...
        plt.savefig("bundle_cluster_0p4_fig/Half_inverse_transparent_50upto200up_" + str(iii) + "_" + str(jjj) + ".png", dpi=100)
plt.close()
